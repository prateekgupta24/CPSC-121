...
int main()
{
  ...
  do{
    ...
    std::cout << "Please select which fans you want to turn on by entering a number 0-4: ";
    std::cin >> choice;
    ...
    switch(choice)
    {
      ...
      case 3:
        ...
        break;
      case 4:
        std::cout << "Emergency Ventilation is now turned on - Please Evacuate the building\n";
        break;
      case 0:
